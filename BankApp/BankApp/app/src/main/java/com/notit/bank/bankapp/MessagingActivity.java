...
/**
 * Created by Beaster on 12/5/2015.
 */
public class MessagingActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exit.setOnClickListener(buttonExitOnClickListener);
    ...
    OnClickListener buttonConnectOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (textUserName.equals("")) {
                Toast.makeText(MessagingActivity.this, "Enter User Name",
            ...
            if (textAddress.equals("")) {
                Toast.makeText(MessagingActivity.this, "Enter Addresse",
                        Toast.LENGTH_LONG).show();
                return;
            }
        ...
        public void run() {
            ...
            try {
                ...
                MessagingActivity.this.runOnUiThread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        Toast.makeText(MessagingActivity.this, eString, Toast.LENGTH_LONG).show();
                    }
